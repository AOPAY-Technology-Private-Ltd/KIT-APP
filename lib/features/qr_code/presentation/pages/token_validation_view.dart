...
class _TokenValidationViewContent extends StatefulWidget {
  ...
  @override
  State<_TokenValidationViewContent> createState() => _TokenValidationViewContentState();
}

class _TokenValidationViewContentState extends State<_TokenValidationViewContent> {
                    ...
                    onPressed: () {
                      setState(() {
                        if (_tokenController.text.trim().isEmpty) {
                          _errorMessage = 'Access token key is required';
                        } else {
                          _errorMessage = null;
                          context.push(RouteNames.installSuccess);
                        }
                      });
                    },
                    child: const Text(
